...
\begin{document}
	...
	\begin{paracol}{2}
		...
		\cvevent{Open-Source R Developer}{slackr}{Oct 2020 -- Present}{}
		
		\begin{itemize}
		\item Current author and maintainer of $slackr$, an R package for connecting R to Slack
		\item Took over as maintainer and then author after fixing a number of broken functions
