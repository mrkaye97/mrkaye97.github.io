...
description: Letting yourself sleep at night by ensuring your SQL is correct
author: Matt Kaye
date: "2023-07-09"
tag: [dbt, analytics engineering, python]
toc: true
toc-depth: 4
...
<Callout emoji="ℹ️" type="info">
  As of version 1.8, dbt now supports unit testing! You can read more [in the
  documentation](https://docs.getdbt.com/docs/build/unit-tests).
</Callout>
...
<Callout emoji="ℹ️" type="info">
  If you're not familiar with dbt, I would recommend reading some of [their
  documentation](https://docs.getdbt.com/) before continuing this post. It will
  not cover many dbt basics.
</Callout>
