...
<Callout emoji="ℹ️" type="info">
  This is a crosspost from [the ZenSearch blog](https://zensearch.jobs/blog/lessons-learned-from-building-zensearch-part-i?utm_source=matt_personal_site&utm_medium=referral)
</Callout>
