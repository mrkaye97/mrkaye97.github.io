...
subtitle: And why I probably won't be doing it again
author: Matt Kaye
date: '2023-06-29'
...
![](nginx-plumber.png){fig-align="center"}
...
This attempts to stop processing the request if the API receives a value for `n` that is not an integer. Unfortunately, it doesn't work. And ironically, the reason why it doesn't work is because of R's type system. If you run this API and make a request to `/double`  with `n=foobar`, you'll get the following response:
